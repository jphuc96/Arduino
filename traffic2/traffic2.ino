...
int n1 = 7;
int n2 = 8;
int carRed1 = 22; // assign the car1 lights
int carYellow1 = 23;
int carGreen1 = 24;
int carRed2 = 25; // assign the car2 lights
int carYellow2 = 26;
int carGreen2 = 27;
int pedRed1 = 30; // assign the pedestrian1 lights
int pedGreen1 = 31;
int pedRed2 = 32; // assign the pedestrian2 lights
int pedGreen2 = 33;
...
digitalWrite(pedRed2, LOW); // ped red 2 on
digitalWrite(carYellow2, LOW); // car yellow 2 off
digitalWrite(carRed2, HIGH); // car red 2 on
digitalWrite(pedGreen2, HIGH); //ped green 2 off
digitalWrite(pedRed1, HIGH); //ped red 1 off
digitalWrite(carRed1, LOW); //car red 1 off
digitalWrite(pedGreen1, LOW); // ped green 1 on
